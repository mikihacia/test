Module.register("MMM-MQTTfloorplan", {
	defaults: {
		...
		door: {
			...
			imageClosed: "light_off", // located in subfolder 'images'
			imageOpen: "light_on", // located in subfolder 'images'
			width: 32, // image width
			height: 32, // image height
		},
		motion: {
			// Default display settings for objects of this type
			image: "motion.png", // located in subfolder 'images'
			width: 32, // image width
			height: 52, // image height
			fadeIntervalS: 10, // How many seconds should we decay the motion icon over ? Do this in 10 steps.
		},
		label: {
			// Default display settings for objects of this type
